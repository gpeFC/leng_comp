    ...
    for idx_1 in range(len(lista)):
        ...
        for idx_2 in range(len(cadena)):
            if cadena[idx_2] == "(" or cadena[idx_2] == ")":
                ...
                print temp_token, idx_2
                if idx_2 < (len(cadena)-1) and cadena[idx_2+1] != "." and cadena[idx_2+1] != "0" and cadena[idx_2+1] != "1" and cadena[idx_2+1] != "2" and cadena[idx_2+1] != "3" and cadena[idx_2+1] != "4" and cadena[idx_2+1] != "5" and cadena[idx_2+1] != "6" and cadena[idx_2+1] != "7" and cadena[idx_2+1] != "8" and cadena[idx_2+1] != "9" and cadena[idx_2+1] != "a" and cadena[idx_2+1] != "A" and cadena[idx_2+1] != "b" and cadena[idx_2+1] != "B" and cadena[idx_2+1] != "c" and cadena[idx_2+1] != "C" and cadena[idx_2+1] != "d" and cadena[idx_2+1] != "D" and cadena[idx_2+1] != "e" and cadena[idx_2+1] != "E" and cadena[idx_2+1] != "f" and cadena[idx_2+1] != "F" and cadena[idx_2+1] != "g" and cadena[idx_2+1] != "G" and cadena[idx_2+1] != "h" and cadena[idx_2+1] != "H" and cadena[idx_2+1] != "i" and cadena[idx_2+1] != "I" and cadena[idx_2+1] != "j" and cadena[idx_2+1] != "J" and cadena[idx_2+1] != "k" and cadena[idx_2+1] != "K" and cadena[idx_2+1] != "l" and cadena[idx_2+1] != "L" and cadena[idx_2+1] != "m" and cadena[idx_2+1] != "M" and cadena[idx_2+1] != "n" and cadena[idx_2+1] != "N" and cadena[idx_2+1] != "o" and cadena[idx_2+1] != "O" and cadena[idx_2+1] != "p" and cadena[idx_2+1] != "P" and cadena[idx_2+1] != "q" and cadena[idx_2+1] != "Q" and cadena[idx_2+1] != "r" and cadena[idx_2+1] != "R" and cadena[idx_2+1] != "s" and cadena[idx_2+1] != "S" and cadena[idx_2+1] != "t" and cadena[idx_2+1] != "T" and cadena[idx_2+1] != "u" and cadena[idx_2+1] != "U" and cadena[idx_2+1] != "v" and cadena[idx_2+1] != "V" and cadena[idx_2+1] != "w" and cadena[idx_2+1] != "W" and cadena[idx_2+1] != "y" and cadena[idx_2+1] != "Y" and cadena[idx_2+1] != "z" and cadena[idx_2+1] != "Z":
                ...
                if idx_2 < (len(cadena)-1) and (cadena[idx_2+1] == "=" or cadena[idx_2+1] == "+" or cadena[idx_2+1] == "-" or cadena[idx_2+1] == "*" or cadena[idx_2+1] == "/" or cadena[idx_2+1] == "^"):
                    temp_lista.append(temp_token)
                    temp_token = ""
...
def coteja_asig(lista):
    if lista[1] == "=":
        if type(lista[0]) == str and (lista[0].isalnum or lista[0].isalpha) and lista[0][0] != "0" and lista[0][0] != "1" and lista[0][0] != "2" and lista[0][0] != "3" and lista[0][0] != "4" and lista[0][0] != "5" and lista[0][0] != "6" and lista[0][0] != "7" and lista[0][0] != "8" and lista[0][0] != "9" and (type(lista[2])==int or type(lista[2])==float):
            return True
        elif (type(lista[0])==int and type(lista[2])==int and lista[0]==lista[2]) or (type(lista[0])==float and type(lista[2])==float and lista[0]==lista[2]) or (type(lista[0])==int and type(lista[2])==float and float(lista[0])==lista[2]) or (type(lista[0])==float and type(lista[2])==int and lista[0]==float(lista[2])):
            return True
        else:
            return False
...
def validez_sintactica(lista):
    if len(lista) == 1:
        ...
        if lista[0] == "(" and (type(lista[1])==int or type(lista[1])==float) and lista[2] == ")": print "Expresión Valida"
        elif coteja_asig(lista): print "Expresión Valida"
        else: print "Expresión Invalida"
